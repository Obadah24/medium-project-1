...
export default function CallToAction() {
  ...
  return (
    <Container as="main" minW="full"  bgGradient={['linear(to-l,brand.900,brand.900,brand.900,brand.900,brand.900, brand.800)','linear(to-l,brand.900,brand.900,brand.900, brand.800)']} mb={['20px', '53px']} pt={['20px', '45px']}>
      <Container as="section" maxW="858px" h={['auto', 'auto', '468px']} mx="auto" display={['flex', 'flex', 'flex']}>
        <Box w={['full', 'full', '330px']} h={['auto', 'auto', '378px']} mr={['0', '0', '145px']} mb={['40px', '40px', '0']}>
          ...
          <Button w={['full', 'full', '180.56px']} h={['50px', '50px', '50px']} fontFamily="Roboto" fontWeight="normal" fontSize={['16px', '16px', '18px']} bg="brand.800" color="second.400" borderRadius="12px">
            {data.calltoaction.Reserve}
          </Button>
        </Box>
        <Flex w={['100px', 'full', '414px']} h={['100px', 'auto', '338px']} m={['110px 10px 15px 0']} alignItems={['center']}>
          <Image h={['100px', '250px', '500px']} w={['100px', 'full', '338px']} borderRadius={["4px","16px"]} src={require('../img/restauranfood.jpg')} alt="food" border="1px solid #333333" />
        </Flex>
      </Container>
    </Container>
  );
